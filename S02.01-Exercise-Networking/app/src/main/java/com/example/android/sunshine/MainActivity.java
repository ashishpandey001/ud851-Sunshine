...
public class MainActivity extends AppCompatActivity {
    ...
    class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... strings) {
            String preferredLocation = strings[0];
            URL requestURL = NetworkUtils.buildUrl(preferredLocation);
            String responseJSONString;
            String[] responseWeatherData = null;
            try {
                responseJSONString = NetworkUtils.getResponseFromHttpUrl(requestURL);
                try {
                    responseWeatherData =
                            OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, responseJSONString);
